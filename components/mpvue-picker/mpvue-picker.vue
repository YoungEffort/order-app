<template>
  <view class="mpvue-picker">
    ...
    <view class="mpvue-picker-content" :class="{'mpvue-picker-view-show':showPicker}">
      <view class="mpvue-picker__hd" catchtouchmove="true" :class="className">
...
<script>
import { transformDateToIndex, getDatePickerIndex, getDays, fixPickerValueDefault } from './utils.js';
